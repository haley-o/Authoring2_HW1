var dynamicContent = {
		spring: {
			...
			'This chicken is super cute',
			'These are tulips!',
			'These birds are blue and nice',
			'The flowers are purple and so nice',
			'Look! Even more butterflies'
			]
		},
		...
		summer : {
			...
			imageDescription : [
			'These chairs are colourful',
			'This dog is sleeping in a hammock',
			'The sand spell out summer',
			'This is the coolest beach in the entire world',
			'What nice flip flops',
			'Fruit is best eaten in summer'
			]
		},
		...
		autumn : {
			...
			imageDescription : [
			'These are autumn leaves on the trees',
			'Pumpkins and sunflowers',
			'More Pumpkins!',
			'The colours in autumn are wonderful',
			'Autumn leaves',
			'An autumn trail'
			]
		},
